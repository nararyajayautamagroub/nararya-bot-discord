...
export const DATA_SOURCES=Object.freeze({news:NEWS_FEEDS,fuel:FUEL_SOURCE_URL,electricity:ELECTRICITY_SOURCE_URL,food:FOOD_SOURCE_URL,electronics:'https://www.bandingin.id/kategori/elektronik',electronicsAudio:'https://www.bandingin.id/kategori/audio',ramadan:RAMADAN_SOURCE_URL,stock:'https://finance.yahoo.com/'});
