...
const feed=new SlashCommandBuilder().setName('feed').setDescription('Kelola sumber notifikasi publik')
 ...
 .addSubcommand(s=>s.setName('defaults').setDescription('Pasang semua sumber JKT48 dari registry ke channel').addChannelOption(o=>o.setName('channel').setDescription('Channel tujuan').addChannelTypes(ChannelType.GuildText)))
