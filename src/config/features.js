export const FEATURE_REGISTRY=[
 ...
 {id:'setup-command',name:'Setup Command',category:'Discord',description:'Ringkasan dan konfigurasi welcome, log, scraper, Ramadan, disaster, dan fitur server lainnya.',status:'active'},
